...
locals {
  ...
  versions = {
    ...
    initial_talos_version    = "v1.10.4", # Do not change this value after initial deployment
    talos_version            = "v1.10.4", # Change this value to safely upgrade the Talos version
